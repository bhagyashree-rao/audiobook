...
def userEntry(Fname,Lname,password,Email):
    userData=pd.read_csv("/home/bhagyashreerao/PycharmProjects/Book-recommender-system/Django/BookRack/account/users.csv",engine="python")
    userId=int(userData['userId'].max())+1
    row=[userId,Fname,Lname,0,Email,password,0]
    with open('/home/bhagyashreerao/PycharmProjects/Book-recommender-system/Django/BookRack/account/users.csv', 'a+', newline='') as write_obj:
